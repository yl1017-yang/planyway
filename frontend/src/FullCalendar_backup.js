...
const FullCalendarPage = () => {
  ...
  const [events, setEvents] = useState([
    ...
    { id: '2', title: '[퍼블] Event 2', description: '내용 2', start: '2024-09-02', end: '2024-09-04', backgroundColor: 'blue', label: '올가' },
    { id: '3', title: 'Event 3', description: '내용 3', start: '2024-09-01', end: '2024-09-01', backgroundColor: 'skyblue', label: '상세' },
    { id: '4', title: 'Event 4', description: '내용 4', start: '2024-09-01', end: '2024-09-01', backgroundColor: 'black', label: '퍼블' },
    { id: '5', title: 'Event 5', description: '내용 5', start: '2024-09-07', end: '2024-09-11', backgroundColor: 'red', label: '외부몰' }
  ]);

    const [showModal, setShowModal] = useState(false);
    const [isEditing, setIsEditing] = useState(false);
    const [selectedEvent, setSelectedEvent] = useState(null);
    const [newEvent, setNewEvent] = useState({ title: '', description: '', start: '', end: '', backgroundColor: '', label: ''});
